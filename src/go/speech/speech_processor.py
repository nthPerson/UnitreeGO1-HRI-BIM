...
TRIGGER_WAV_SCRIPT = "/home/dicelabs/UnitreeGO1-HRI-BIM/src/go/speech/dog_trigger_speech.sh"
SEND_WAV_SCRIPT = "/home/dicelabs/UnitreeGO1-HRI-BIM/src/go/speech/dog_send_speech.sh"
############################################################
...
"""
#TODO fix imports for more modularity
TEMPORARY_WAV_FILE = '/home/dicelabs/UnitreeGO1-HRI-BIM/src/go/speech/waves/temp.wav'
############################################################

class SpeechProcessor:
    def __init__(self):
        self.api_key = os.getenv("SPEECH_KEY")
        if not self.api_key:
            raise ValueError("SPEECH_KEY is not configured in the environment")
        self.voice_id = "NFG5qt843uXKj4pFvR7C" # Specify the correct voice ID
        self.base_url = "https://api.elevenlabs.io/v1/text-to-speech/"
        #TODO fix imports for more modularity
        self.output_dir = "/home/dicelabs/UnitreeGO1-HRI-BIM/src/go/speech/waves"
